...
-- Generation Time: Jan 10, 2025 at 01:17 AM
...
INSERT INTO `laptops` (`laptop_id`, `brand`, `model`, `specifications`, `price`, `stock`, `created_at`) VALUES
(1, 'Lenovo', 'IdeaPad 3', 'AMD Ryzen 5, 8GB RAM, 512GB SSD', '80000000.00', 50, '2024-12-08 05:53:58'),
(6, 'tt', 'ff', 'tt', '3333.00', 3, '2024-12-08 08:07:20');
...
--
ALTER TABLE `inventory`
  ADD CONSTRAINT `inventory_ibfk_1` FOREIGN KEY (`laptop_id`) REFERENCES `laptops` (`laptop_id`),
...
--
ALTER TABLE `promotions`
  ADD CONSTRAINT `promotions_ibfk_1` FOREIGN KEY (`laptop_id`) REFERENCES `laptops` (`laptop_id`);
COMMIT;
